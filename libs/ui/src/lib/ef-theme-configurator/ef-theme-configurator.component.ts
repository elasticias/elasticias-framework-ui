...
@Component({
    ...
    template: `
        <div class="config-panel-content">
            ...
            <div class="config-panel-colors">
                <span class="config-panel-label">{{ surfaceLabelKey | translate }}</span>
                <div>
            ...
            <div class="config-panel-settings">
                <span class="config-panel-label">{{ presetLabelKey | translate }}</span>
                <p-selectbutton
                ...
                >
                    <ng-template #item let-item>
                        {{ (presetsDisplayNameKeys[item] || item) | translate }}
                    </ng-template>
                </p-selectbutton>
            </div>
...
export class EfThemeConfiguratorComponent implements OnInit {
    ...
    @Input() rippleLabelKey = 'configurator.ripple';
    @Input() rtlLabelKey = 'configurator.rtl';
    @Input() presetsDisplayNameKeys: Record<string, string> = {
        Aura: 'configurator.preset_compact',
        Lara: 'configurator.preset_modern',
        Material: 'configurator.preset_google',
        Nora: 'configurator.preset_classic',
    };
    ...
    configService: EfThemeConfigService = inject(EfThemeConfigService);
    platformId = inject(PLATFORM_ID);

    presetsOptions = Object.keys(PRESETS);
